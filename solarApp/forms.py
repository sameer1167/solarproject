...
class UserProfileForm(forms.ModelForm):
	...
	pin_code=forms.CharField(label="", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Pin-Code'}) ,required=False)
	country=   forms.CharField(label="", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Country'}) ,required=False)


	class Meta:
		model=profile
		fields=('phone','address_1','address_2','city','state','pin_code','country')
		# fields='__all__'
...
class SignUpForm(UserCreationForm):
	...
	def __init__(self, *args, **kwargs):										#kind of bootstrap things
...
class UpdateUserForms(UserChangeForm):
	...
	def __init__(self, *args, **kwargs):
		super(UpdateUserForms, self).__init__(*args, **kwargs)
